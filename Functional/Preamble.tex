...
\setlist[enumerate, 1]{leftmargin=2cm, label={\textbf{\thesection.\arabic*}}}
\setlist[enumerate, 2]{leftmargin=1cm, label*=\textbf{.\arabic*}}
\setlist[enumerate, 3]{leftmargin=1cm, label*=\textbf{.\arabic*}}
\setlist[enumerate, 4]{leftmargin=1cm, label*=\textbf{.\arabic*}}
\setlist[enumerate, 5]{leftmargin=1cm, label*=\textbf{.\arabic*}}
